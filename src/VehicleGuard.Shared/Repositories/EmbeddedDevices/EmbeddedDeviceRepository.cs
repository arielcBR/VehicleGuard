...
namespace VehicleGuard.Shared.Repositories.EmbeddedDevices;
...
public class EmbeddedDeviceRepository : IEmbeddedDeviceRepository
{
    ...
    public EmbeddedDeviceRepository(TrackerDbContext database, IVehicleRepository vehicleRepository)
    {
        _db = database;
